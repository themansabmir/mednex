        ...
        <div className='max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden md:flex md:px-8'>
          <div className='flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl'>
            ...
            <h2 className='text-4xl text-gray-800 font-extrabold md:text-5xl'>
              Effortless Medical Archiving – Secure, Compliant, Accessible
            </h2>
            <p>
              Transform the way you manage medical records. Our secure and
              efficient archival solutions ensure easy access, compliance, and
              peace of mind—because every record matters.
            </p>
          ...
          <div className='flex-none mt-14 md:mt-0 md:max-w-xl'>
            <img
              src='https://images.pexels.com/photos/8872714/pexels-photo-8872714.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2'
